...
public class NewInstanceTest {
    ...
    public void testNewInstance() throws ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Class<?> clazz = Class.forName("com.java基础.反射.Person");
        //方式一
     ...
     */
    @Test
    public void test2() throws IllegalAccessException, ClassNotFoundException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        //0,1,2
        ...
        switch (num) {
            ...
            case 1:
                ...
                break;
            case 2:
                classPath = "com.java基础.反射.Person";
                break;
            default:
                break;
        }
    ...
    public Object getInstance(String classPath) throws IllegalAccessException, InstantiationException, ClassNotFoundException, NoSuchMethodException, InvocationTargetException {
